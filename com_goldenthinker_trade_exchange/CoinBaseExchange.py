...
class CoinBaseExchange(Exchange):
    ...
    def __init__(self):
        ...
        self.auth_client = cbpro.AuthenticatedClient(CoinBaseExchange.API_KEY, CoinBaseExchange.API_SECRET, CoinBaseExchange.PWD)
    ...
    def balance(self,symbol):
        ...
        def get_account_number_from_symbol(symbol):
            return "7d0f7d8e-dd34-4d9c-a846-06f431c381ba"
            
        return self.auth_client.get_account(get_account_number_from_symbol(symbol))
